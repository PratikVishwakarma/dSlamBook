...
public class ChatListAdapter extends ArrayAdapter<Chat> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(chat.getMessageType().equals(Constant.CHAT_MESSAGE_TYPE_SENT)){
            ...
            message_seen = (ImageView) listItemView.findViewById(R.id.single_chat_item_message_seen);
            if(chat.getSeenType().equals(Constant.CHAT_MESSAGE_SEEN_TYPE_SENT_SEEN)){
                message_seen.setVisibility(View.VISIBLE);
            }

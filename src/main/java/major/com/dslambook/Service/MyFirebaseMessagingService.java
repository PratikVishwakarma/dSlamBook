...
import major.com.dslambook.UI.userFriendsActivity;
...
//    }
    ...
    private void sendNotification(String messageBody) {
        Log.e("notification message ", messageBody);
        if(messageBody.contains("like")){
            notificationIntent = new Intent(this, homeActivity.class);
            notificationIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        } else if(messageBody.contains("friend request")){
            notificationIntent = new Intent(this, userFriendsActivity.class);
            notificationIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        } else{
            notificationIntent = new Intent(this, homeActivity.class);
            notificationIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
